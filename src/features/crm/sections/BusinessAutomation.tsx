    ...
    <section className="w-full py-16 bg-white overflow-hidden">
      <div className="max-w-full mx-auto flex flex-col lg:flex-row gap-10 lg:gap-16">
        ...
        <motion.div 
          ...
          className="flex-1 bg-gradient-to-br from-black to-[#00a8ff] p-8 md:p-12 lg:p-16 rounded-r-[24px] lg:rounded-r-[48px] text-white"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              <div key={idx} className="flex items-center gap-4 text-base md:text-lg">
                <span className="w-9 h-9 bg-white text-[#ff6a00] rounded-full flex items-center justify-center font-bold shrink-0">
                  ✓
                </span>
                <span>{feature}</span>
              </div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[18px] p-6 md:p-7 flex gap-5 items-center shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-slate-50">
              <div className="w-12 h-12 rounded-full bg-[#fff2e6] text-[#ff6a00] text-xl flex items-center justify-center shrink-0 font-bold">
                $
              </div>
            ...
            {/* Stat 2 */}
            <div className="bg-white rounded-[18px] p-6 md:p-7 flex gap-5 items-center shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-slate-50">
              <div className="w-12 h-12 rounded-full bg-[#fff2e6] text-[#ff6a00] text-2xl flex items-center justify-center shrink-0 font-bold">
                +
              </div>
              <div className="flex-1">
            ...
            {/* Stat 3 */}
            <div className="bg-white rounded-[18px] p-6 md:p-7 flex gap-5 items-center shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-slate-50">
              <div className="w-12 h-12 rounded-full bg-[#fff2e6] text-[#ff6a00] text-2xl flex items-center justify-center shrink-0">
                ⏱
              </div>
              <div className="flex-1">
