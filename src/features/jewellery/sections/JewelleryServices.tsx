...
const services = [
  {
    ...
    desc: "Drive showroom visits with Google + Meta ads. Target people near your store who are actively looking to buy.",
    image: "https://ik.imagekit.io/digitalroipune/Perf.-Marketing.gif",
    imageLeft: true
  },
  {
    title: "Content & Creative Services",
    desc: "Ads that build trust and interest. Show collections, craftsmanship, pricing cues, and store experience.",
    image: "https://ik.imagekit.io/digitalroipune/Creative.gif",
    imageLeft: false
  },
  {
    title: "Landing Page Optimization",
    desc: "Make it easy to visit. Pages built for Call, Directions, and Book Appointment.",
    image: "https://ik.imagekit.io/digitalroipune/Landing-Page.gif",
    imageLeft: true
  },
  {
    title: "WhatsApp Automation",
    desc: "Instant replies that convert. Share catalog, answer queries, send location, and confirm appointments.",
    image: "https://ik.imagekit.io/digitalroipune/WhatsApp-Automation.gif",
    imageLeft: false
  },
  {
    title: "CRM Integration",
    desc: "No lead gets missed. Every enquiry is tracked and followed up until they visit.",
    image: "https://ik.imagekit.io/digitalroipune/CRM-Automation.gif",
    imageLeft: true
  },
  {
    title: "Data Tracking & Analytics",
    desc: "Know what drives walk-ins. Track calls, WhatsApp clicks, appointment bookings, and store-visit intent.",
    image: "https://ik.imagekit.io/digitalroipune/Data-Tracking.gif",
    imageLeft: false
  }
];

export const JewelleryServices: React.FC = () => {
  return (
    <section 
